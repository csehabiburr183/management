...
if (isset($_POST['subbtn'])) {
	...
	$insert= "INSERT INTO teacher_table (name, mobile, email, pass)
	 VALUES ('$name', '$mobile', '$email', '$pass' )";

	if (mysqli_query($conn, $insert)) {
		$tmsg = "New Teacher Record Succssfully Inserted";
	}

	else{
		echo "Error To Insert " . $insert . "<br/>". mysqli_error($conn);
	}
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="add_teacher.php">Add Teacher Information</a>
...
<form action="" method="post">
  ...
  <div class="form-group">
    <label for="roll"> Mobile No </label>
    <input type="number" class="form-control" placeholder="Enter Mobile Number"
     id="roll" name="mobile" required>
  </div>
